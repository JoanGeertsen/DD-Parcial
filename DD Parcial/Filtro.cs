...
namespace DD_Parcial
{
    public class Filtro: Cafe
    {
        ...
        public Filtro(string _Nombre, int _Codigo, DateTime _FechaVencimiento, int _Stock, double _Precio, string _Tueste, string _Origen, bool _Molido, bool _ConAzucar) 
